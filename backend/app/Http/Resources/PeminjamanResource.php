...
class PeminjamanResource extends JsonResource
{
    ...
    { 
        return [ 
            ...
            'tgl_pinjam' => $this->tgl_pinjam?->format('Y-m-d H:i:s'), 
            'tgl_kembali_plan' => $this->tgl_kembali_plan?->format('Y-m-d H:i:s'), 
            'status' => $this->status, 
            ...
            'info_pengembalian' => $this->whenLoaded('pengembalian', function () { 
                ...
                return [ 
                    'tgl_kembali' => $this->pengembalian->tgl_kembali?->format('Y-m-d H:i:s'), 
